...
def upstreamProjects = [
  ...
  'taglib', // <groupId>com.pragmatickm</groupId><artifactId>pragmatickm-password-taglib</artifactId>

  // Runtime Direct
  'renderer-html', // <groupId>com.pragmatickm</groupId><artifactId>pragmatickm-password-renderer-html</artifactId>
  'style', // <groupId>com.pragmatickm</groupId><artifactId>pragmatickm-password-style</artifactId>
  'view', // <groupId>com.pragmatickm</groupId><artifactId>pragmatickm-password-view</artifactId>
